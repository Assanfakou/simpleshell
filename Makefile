...
SRC = execution/builtins/do_cd.c execution/builtins/do_echo.c execution/builtins/do_env.c execution/builtins/do_exit.c execution/builtins/do_export.c execution/builtins/do_export_helpers.c\
      ...
      execution/pipe_ex_helpers.c  execution/pipe_ex_helpers2.c execution/utils.c execution/utils2.c execution/dup_utils.c execution/redirections.c \
      execution/pipe_executor.c execution/main.c execution/main_helpers.c\
      ...
      signals.c lexer/exit_status.c lexer/herdoc_parser.c execution/herdoc_executter.c 
