...
SRC = execution_part/builtins/do_cd.c execution_part/builtins/do_echo.c execution_part/builtins/do_env.c execution_part/builtins/do_exit.c execution_part/builtins/do_export.c \
 ...
 lexer/exit_status.c execution_part/execute_external.c execution_part/redirections.c execution_part/pipe_executor.c execution_part/execution/main.c lexer/error.c lexer/expand.c lexer/lexer_help.c lexer/main.c lexer/parce.c lexer/t_cmd_helpers.c lexer/token_help.c lexer/tokenizing.c \
	execution_part/execution/free_env.c lexer/signals.c
